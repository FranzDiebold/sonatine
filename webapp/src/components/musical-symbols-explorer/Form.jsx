...
import useStateWithSessionStorage from '../../util/stateWithSessionStorage';
...
function Form(props) {
  const [state, setState] = useStateWithSessionStorage(INITIAL_FORM_STATE, 'musicalSymbolsExplorerFormState');
