        ...
        <Container>
          ...
          <Navbar.Menu >
            <Navbar.Container>
              ...
              <Navbar.Item to="/hilfe" renderAs={NavLink} activeClassName="is-active" onClick={hideNavbar}>
                <Icon>
                  <svg style={{ width: 24, height: 24 }} viewBox="0 0 24 24">
            ...
            <Navbar.Container position="end">
              <Navbar.Item href="https://github.com/FranzDiebold/sonatine" target="_blank" className="has-tooltip-left" data-tooltip="Dieses Projekt ist Open Source!">
                <Icon>
                  <svg style={{ width: 24, height: 24 }} viewBox="0 0 24 24">
